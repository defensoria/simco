...
public class ReporteGeneralController implements Serializable {
    ...
    public void resumenEjecutivo() throws JRException, IOException{
        ...
        ejecutivo.setPorcentajeGeneralDialogoProceso(cambiarPorcentaje(totalGeneralDialogo,totalGeneralDialogoProceso , "DE LOS CASOS EN DIALOGO"));
        ...
        sb.append("En el presente mes se registraron "+totalCasosMes+" conflictos: "+ejecutivo.getTotalCasosActivoMes()+" casos activos y "+ejecutivo.getTotalCasosLatenteMes()+" latentes (ver Gráfico N° 1). Del");
        sb.append("total de casos activos, "+ejecutivo.getTotalCasosGeneralDiagolo()+" se encuentran en fase de diálogo lo que representa el "+cambiarPorcentaje(totalCasos,ejecutivo.getTotalCasosGeneralDiagolo())+" del total de los ");
