...
public enum AntesDespuesType {
	...
	/** La Constante list. */
	private static final List<AntesDespuesType> list = new ArrayList<AntesDespuesType>();
	
	/** La Constante lookup. */
	private static final Map<String, AntesDespuesType> lookup = new HashMap<String, AntesDespuesType>();
